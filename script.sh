...
case "$COMMAND" in
  ...
  build)
    ...
    ;;
  ui)
    npm install --prefix //Fleet.UI/node_modules ./Fleet.UI
    REACT_APP_HERE_APP_ID=fLR4pqJX0jZZZle8nwaM REACT_APP_HERE_APP_CODE=eM1d0zQLOLaA44cULr6NwQ npm start --prefix ./Fleet.UI
    ;;
  *)
    usage
    exit 1
