...
namespace Fleet.FuelOptimization.Services
{
    public class Optimization : IOptimization
    {
        ...
        public void Init(double[] Costs, double[] Volumes, int Tank, int Remainder, int Minimum_remainder)
        {
            remainder = Remainder;
        ...
        double[] Simplify(double[] plane)
        {
            ...
            volumeremainders[0] = remainder - minimum_remainder + plane[0];
            for (int i = 1; i < n; i++)
            {
        ...
        //     while (j < n - 2)
        //     {
        //         while (costs[j] != costs[j + 1]) j++;
        //         if (j < n - 2)
        //         {
        //             k = j + 1;
        //             while (costs[k] == costs[j] && volumeremainders[k] - simple[k] > volumes[k] && k < n - 1)
        //             {
        //                 volumeremainders[k] -= simple[k];
        //                 simple[k + 1] += simple[k];
        //                 simple[k] = 0;
        //                 k++;
        //             }
        ...
        public string PrintTable(double[,] M)
        {
            string s = "";
        ...
        {
            Init(data.Costs, data.Volumes, data.Tank, data.Remainder, data.MinimumRemainder);
